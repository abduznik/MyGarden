# Initial setup
First you have to USB Flash the Raspbian Operating System in 64-bits,make sure you make the username as **pi**. After you've installed it and flashed it into an SD-card you will boot from your Raspberry Pi and first of all install all requirements.
```bash
...
```
once this command has finished you will reboot the Raspberry
```bash
sudo reboot
```

## you can get from GitHub this Repository [auto-installer ](https://github.com/abduznik/gpib-rpi)
